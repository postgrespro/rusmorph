...
# endif   // LIBMORPH_NAMESPACE
  ...
  extern unsigned char const flexTree[];
  extern unsigned char const mxTables[];
  extern unsigned char const mixTypes[];
  extern unsigned char const classmap[];
  extern unsigned char const stemtree[];
  extern unsigned char const lidstree[];

  extern  unsigned     const pspMinCapValue[];
